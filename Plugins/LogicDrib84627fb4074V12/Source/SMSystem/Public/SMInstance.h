...
public:
	 ...
	 * Note that this will be true if the state machine was stopped via `#bStopOnEndState`.
	 */
	UFUNCTION(BlueprintCallable, Category = "Logic Driver|State Machine Instances")
...
protected:
	...
	UPROPERTY(meta = (DisplayName = "Node Class", ToolTip = "The custom state machine node class assigned to the root state machine. This is used for rule evaluation, for exposing variables on state machine references, or for compile validation."))
